...
class SurfaceData:
    ...
    def get_property(self, name: str) -> Attribute:
        """
        Get a property as an Attribute view.

        The returned Attribute is a view of the underlying data,
        ...
        Returns:
            Attribute view of the property.
        ...
        return Attribute.as_view(self.properties[name], item_size, name)
